                        ...
                        value: function() {
                            ...
                            if (
                                ...
                                var d = new p(function(b) {
                                    for (var c = 0; c < b.length; c++)
                                        for (
                                            var d = b[c], e = 0; e < d.addedNodes.length; e++
                                        ) {
                    ...
                    },
                    {
                        ...
                        value: function(a, b, c, d, e) {
                            return (
                                ...
                                this.vendorSet(a.style, {
                                    animationName: b ?
                                        "none" : this.cachedAnimationName(a),
                                }),
                                a
                            );
                        },
                        ...
                        value: function(a, b) {
                            for (var c in b)
                                if (b.hasOwnProperty(c)) {
                                    ...
                                    a["" + c] = d;
                                    for (
                                        var e = 0; e < this.vendors.length; e++
                                    ) {
                    ...
                    },
                    {
                        ...
                        value: function() {
                            if (this.scrolled) {
                                this.scrolled = !1;
                                for (
                                    var a = [], b = 0; b < this.boxes.length; b++
                                ) {
                                    var c = this.boxes[b];
                                    if (c) {
                                        if (this.isVisible(c)) {
